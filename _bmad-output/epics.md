...
Developers can diagnose and resolve common Beads issues in ≤5 steps, addressing Issue #376 core complaint.

### Story 2.1: Recovery Overview Page [bd-9g9.1]

As a **developer experiencing issues**,
I want **a recovery overview page**,
So that **I can quickly identify which recovery runbook applies to my situation**.

**Acceptance Criteria:**

**Given** no recovery documentation exists
**When** I create `docs/recovery/index.md`
**Then** page lists all common failure scenarios
**And** each scenario links to specific runbook
**And** symptoms are clearly listed for each scenario
**And** page follows Diátaxis How-to category rules
**And** page is under 2000 words (NFR6)

---

### Story 2.2: Database Corruption Recovery [bd-9g9.2]

As a **developer with SQLite database issues**,
I want **a database corruption recovery runbook**,
So that **I can restore my beads database in ≤5 steps**.

**Acceptance Criteria:**

**Given** user has database corruption symptoms
**When** user follows `docs/recovery/database-corruption.md`
**Then** Symptoms section lists observable corruption signs
**And** Diagnosis section provides `bd` commands to verify corruption
**And** Solution section has ≤5 explicit steps with commands
**And** each step has expected output shown
**And** Prevention section explains how to avoid corruption
**And** page follows Recovery Section Format from Architecture

---

### Story 2.3: Merge Conflicts Recovery [bd-9g9.3]

As a **developer with JSONL merge conflicts**,
I want **a merge conflicts recovery runbook**,
So that **I can resolve conflicts without losing data**.

**Acceptance Criteria:**

**Given** user has JSONL merge conflict symptoms
**When** user follows `docs/recovery/merge-conflicts.md`
**Then** Symptoms section lists conflict indicators
**And** Diagnosis section shows how to identify conflicts
**And** Solution section has ≤5 steps for resolution
**And** explains `bd sync` force options
**And** Prevention section covers sync workflow best practices

---

### Story 2.4: Circular Dependencies Recovery [bd-9g9.4]

As a **developer with circular dependency errors**,
I want **a circular dependencies recovery runbook**,
So that **I can detect and break dependency cycles**.

**Acceptance Criteria:**

**Given** user has circular dependency symptoms
**When** user follows `docs/recovery/circular-dependencies.md`
**Then** Symptoms section lists cycle detection errors
**And** Diagnosis section shows `bd blocked` and dependency commands
**And** Solution section has ≤5 steps to break cycles
**And** explains `bd dep remove` usage
**And** Prevention section covers dependency best practices

---

### Story 2.5: Sync Failures Recovery [bd-9g9.5]

As a **developer with sync failures**,
I want **a sync failures recovery runbook**,
So that **I can restore sync functionality**.

**Acceptance Criteria:**

**Given** user has `bd sync` failures
**When** user follows `docs/recovery/sync-failures.md`
**Then** Symptoms section lists common sync error messages
**And** Diagnosis section covers network, permission, and state issues
**And** Solution section has ≤5 steps including `--force-rebuild`
**And** covers daemon issues and restart procedures
**And** Prevention section covers sync workflow recommendations
