...
var migrationsList = []Migration{
	...
	{"namespace_project_branch_columns", migrations.MigrateNamespaceColumns},
}
...
func getMigrationDescription(name string) string {
	descriptions := map[string]string{
		...
		"namespace_project_branch_columns": "Adds project and branch columns for branch-based issue namespacing (BRANCH_NAMESPACING.md)",
	}
