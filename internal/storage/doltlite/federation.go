...
func (s *DoltliteStore) ensureCredentialKey() error {
...
func (s *DoltliteStore) encryptPassword(password string) ([]byte, error) {
	if password == "" {
		return nil, nil
	}
...
func (s *DoltliteStore) decryptPassword(encrypted []byte) (string, error) {
	if len(encrypted) == 0 {
		return "", nil
	}
	if err := s.ensureCredentialKey(); err != nil {
...
func (s *DoltliteStore) AddFederationPeer(ctx context.Context, peer *storage.FederationPeer) error {
...
func (s *DoltliteStore) GetFederationPeer(ctx context.Context, name string) (*storage.FederationPeer, error) {
...
func (s *DoltliteStore) ListFederationPeers(ctx context.Context) ([]*storage.FederationPeer, error) {
...
func (s *DoltliteStore) RemoveFederationPeer(ctx context.Context, name string) error {
	if err := s.withConn(ctx, true, func(tx *sql.Tx) error {
...
func (s *DoltliteStore) Sync(ctx context.Context, peer string, strategy string) (*storage.SyncResult, error) {
...
func (s *DoltliteStore) SyncStatus(ctx context.Context, peer string) (*storage.SyncStatus, error) {
...
func (s *DoltliteStore) setLastSyncTime(ctx context.Context, peer string) error {
	key := "last_sync_" + peer
...
func (s *DoltliteStore) getLastSyncTime(ctx context.Context, peer string) time.Time {
	key := "last_sync_" + peer
	var value string
	err := s.withConn(ctx, false, func(tx *sql.Tx) error {
