...
type Config struct {
	...
	Backend  string `json:"backend,omitempty"` // Backend name ("dolt" or "postgres"). Empty defaults to BackendDolt.
...
// GetBackend returns the configured backend name, defaulting to BackendDolt.
