...
// TestGetBackend verifies that GetBackend returns the correct backend string.
func TestGetBackend(t *testing.T) {
	tests := []struct {
		...
		{name: "postgres backend", cfg: &Config{Backend: BackendPostgres}, want: BackendPostgres},
	}
