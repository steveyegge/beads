...
.PHONY: all build test test-icu-path test-full-cgo test-regression test-upgrade test-cross-version test-migration bench bench-quick bench-postgres clean clean-test-tmp install install-force help check-up-to-date fmt fmt-check
