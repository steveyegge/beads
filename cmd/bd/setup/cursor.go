...
const cursorRulesTemplateBase = `# Beads Issue Tracking
...
func cursorRulesTemplate() string {
	if !UseWorkflowFirst {
		return cursorRulesTemplateBase
	}
	marker := "\n# END BEADS INTEGRATION\n"
	addendum := "\n\n" + recipes.WorkflowFirstAddendum + marker
	return strings.Replace(cursorRulesTemplateBase, marker, addendum, 1)
}
