...
func init() {
	...
	createCmd.Flags().StringP("type", "t", "task", "Issue type (bug|feature|task|epic|chore|runbook|merge-request|molecule|gate|agent|role|rig|convoy|event); enhancement is alias for feature, rb is alias for runbook")
