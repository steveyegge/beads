...
This is used by 'gt done --phase-complete' to register for gate wake notifications.`,
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		// Add waiter via GateWait RPC which handles waiters correctly
		{
